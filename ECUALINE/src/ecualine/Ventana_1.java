...
public class Ventana_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(211, 211, 211), 1, true));
        ...
        jLabel4.setText("Calculadora de ecuaciones lineales | ELIMINACIÓN GAUSSIANA");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/header1.png"))); // NOI18N
    ...
    private double[][] resolver(double matriz[][]) {
        for (int i = 0; i < matriz.length; i++) { // LEEMOS LA MATRIZ DE n * (n + 1) DADA POR EL USUARIO
            ...
            for (int j = i + 1; j < matriz.length; j++) {
                ...
                double cero = matriz[j][i] * -1;
                    ...
                    for (int k = i; k < matriz[i].length; k++) {
        ...
        double r[] = new double[matriz.length];
        r[matriz.length - 1] = matriz[matriz.length - 1][matriz.length];
        for (int i = matriz.length - 2; i >=  0; i--) {
            for (int j = i + 1; j < matriz[i].length - 1; j++) {
                r[i] += r[j] * -matriz[i][j];
            }
            r[i]+=matriz[i][matriz[i].length - 1];
        }
        jTextArea.append("\nLos resultados obtenidos son: ");
        for (int j = 0; j < r.length; j++) {
            jTextArea.append("\nX" + (j + 1) + " = " + fracciones.decFraccion(r[j]));
        }
